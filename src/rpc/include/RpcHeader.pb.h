...
class RpcHeader final :
 ...
 public:
  ...
  // .tinyRPC.MessageType type = 1;
  void clear_type();
  ::tinyRPC::MessageType type() const;
  void set_type(::tinyRPC::MessageType value);
  private:
  ::tinyRPC::MessageType _internal_type() const;
  void _internal_set_type(::tinyRPC::MessageType value);
  public:

  // .tinyRPC.ErrorCode error = 4;
  void clear_error();
  ::tinyRPC::ErrorCode error() const;
  void set_error(::tinyRPC::ErrorCode value);
  private:
  ::tinyRPC::ErrorCode _internal_error() const;
  void _internal_set_error(::tinyRPC::ErrorCode value);
  public:
...
inline ::tinyRPC::MessageType RpcHeader::_internal_type() const {
  return static_cast< ::tinyRPC::MessageType >(_impl_.type_);
}
inline ::tinyRPC::MessageType RpcHeader::type() const {
  // @@protoc_insertion_point(field_get:tinyRPC.RpcHeader.type)
  return _internal_type();
}
inline void RpcHeader::_internal_set_type(::tinyRPC::MessageType value) {
  
  _impl_.type_ = value;
}
inline void RpcHeader::set_type(::tinyRPC::MessageType value) {
  _internal_set_type(value);
  // @@protoc_insertion_point(field_set:tinyRPC.RpcHeader.type)
}
...
inline ::tinyRPC::ErrorCode RpcHeader::_internal_error() const {
  return static_cast< ::tinyRPC::ErrorCode >(_impl_.error_);
}
inline ::tinyRPC::ErrorCode RpcHeader::error() const {
  // @@protoc_insertion_point(field_get:tinyRPC.RpcHeader.error)
  return _internal_error();
}
inline void RpcHeader::_internal_set_error(::tinyRPC::ErrorCode value) {
  
  _impl_.error_ = value;
}
inline void RpcHeader::set_error(::tinyRPC::ErrorCode value) {
  _internal_set_error(value);
  // @@protoc_insertion_point(field_set:tinyRPC.RpcHeader.error)
}
...
template <> struct is_proto_enum< ::tinyRPC::MessageType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::tinyRPC::MessageType>() {
  return ::tinyRPC::MessageType_descriptor();
}
template <> struct is_proto_enum< ::tinyRPC::ErrorCode> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::tinyRPC::ErrorCode>() {
  return ::tinyRPC::ErrorCode_descriptor();
}
