...
static const ::_pb::EnumDescriptor* file_level_enum_descriptors_RpcHeader_2eproto[2];
...
const char descriptor_table_protodef_RpcHeader_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\017RpcHeader.proto\022\007tinyRPC\"\220\001\n\tRpcHeader"
  "\022\"\n\004type\030\001 \001(\0162\024.tinyRPC.MessageType\022\024\n\014"
  "service_name\030\002 \001(\014\022\023\n\013method_name\030\003 \001(\014\022"
  "!\n\005error\030\004 \001(\0162\022.tinyRPC.ErrorCode\022\021\n\tar"
  "gs_size\030\005 \001(\r*d\n\013MessageType\022\024\n\020RPC_TYPE"
  "_UNKNOWN\020\000\022\024\n\020RPC_TYPE_REQUEST\020\001\022\025\n\021RPC_"
  "TYPE_RESPONSE\020\002\022\022\n\016RPC_TYPE_ERROR\020\003*\205\001\n\t"
  "ErrorCode\022\016\n\nRPC_ERR_OK\020\000\022\026\n\022RPC_ERR_NO_"
  "SERVICE\020\001\022\025\n\021RPC_ERR_NO_METHOD\020\002\022\033\n\027RPC_"
  "ERR_INVALID_REQUEST\020\003\022\034\n\030RPC_ERR_INVALID"
  "_RESPONSE\020\004b\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_RpcHeader_2eproto = {
    false, false, 419, descriptor_table_protodef_RpcHeader_2eproto,
    "RpcHeader.proto",
...
RpcHeader::RpcHeader(const RpcHeader& from)
  ...
  ::memcpy(&_impl_.type_, &from._impl_.type_,
    ...
    reinterpret_cast<char*>(&_impl_.type_)) + sizeof(_impl_.args_size_));
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 8)) {
          ...
          CHK_(ptr);
          _internal_set_type(static_cast<::tinyRPC::MessageType>(val));
        } else
          goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 32)) {
          uint64_t val = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
          _internal_set_error(static_cast<::tinyRPC::ErrorCode>(val));
        } else
          goto handle_unusual;
        continue;
      // uint32 args_size = 5;
...
uint8_t* RpcHeader::_InternalSerialize(
  ...
  if (this->_internal_args_size() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(5, this->_internal_args_size(), target);
  }
